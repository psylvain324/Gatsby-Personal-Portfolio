...
const LinkButton = ({link, children, data}) => {
	return (
        <button className="btn-share">
        <span className="btn-text">Social Media</span><span className="btn-icon">
            <svg t="1580465783605" className="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="9773" width="20" height="20">
        ...
        <ul className="social-icons">
            ...
            <li>
                <a href="https://github.com/psylvain324" target="_blank" rel="noreferrer">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="white" viewBox="0 0 24 24">
