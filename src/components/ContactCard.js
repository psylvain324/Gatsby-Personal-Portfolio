...
import ComponentStyle from '../assets/css/components.css';
        ...
        <div className="contact-card-container">
            <div className="contact-card-front contact-card-side">
                <div className="content">
                    ...
                    <p> I am a front and backend web developer.
                        I specialize in the backend but have more recently worked client side.
                        Throughout my career, I have adapted my skills
                        through a constant continual learning mentality.
                    </p>
                </div>
            </div>
