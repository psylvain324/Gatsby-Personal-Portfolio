        ...
        <div className="box alt">
          <div className="row gtr-uniform">
            <section className="col-4 col-6-medium col-12-xsmall">
              ...
              <div>
                <p>
                  C#, ASP.Net Core, Visual Studio, MVC, Entity Framework, Razor
                  Pages, LINQ, XUnit, NUnit
                </p>
              </div>
            </section>
            <section className="col-4 col-6-medium col-12-xsmall">
              ...
              <div>
                <p>
                  Java, Spring Boot, Hibernate, JPA, JDBC, AOP, Reactive Spring,
                  Intellij, Eclipse
                </p>
              </div>
            </section>
            <section className="col-4 col-6-medium col-12-xsmall">
              ...
              <div>
                <p>
                  Angular2, Typescript, RxJs, NgRx, Reactive Forms, Angular
                  Material, Jasmine
                </p>
              </div>
            </section>
            <section className="col-4 col-6-medium col-12-xsmall">
              ...
              <div>
                <p>
                  SQL Management Studio, Oracle, MySQL, Complex Queries,
                  Database Design
                </p>
              </div>
            </section>
            <section className="col-4 col-6-medium col-12-xsmall">
              ...
              <div>
                <p>Javascript, ES6, Ajax, jQuery, Visual Studio Code</p>
              </div>
            </section>
            <section className="col-4 col-6-medium col-12-xsmall">
              <div id="react" className="image-animation"></div>
              <div>
                <p>React, JSX, Babel, Material UI, Redux, GatsbyJS</p>
              </div>
            </section>
          </div>
        </div>
